...
//SINGLE POST
Route::get('/post/single/{id}', [\App\Http\Controllers\front\FrontendController::class, 'single'])->name('singlePost');

//COMMENTS - FRONT
Route::group(['prefix' => '/user/comment'], function (){

    Route::post('/store/{id}', [\App\Http\Controllers\front\CommentController::class, 'store'])->name('storeComment');
    Route::get('/confirm/view/{id}', [\App\Http\Controllers\front\CommentController::class, 'confirmCommentView'])->name('confirmCommentView');
    Route::post('/confirm/{id}/{selector}', [\App\Http\Controllers\front\CommentController::class, 'confirm'])->name('confirmComment');
...
//SINGLE CATEGORY
Route::get('/category/{id}', [\App\Http\Controllers\front\FrontendController::class, 'category'])->name('singleCategory');


//LIKES

Route::get('/like/{postID}', [ \App\Http\Controllers\front\LikeControlller::class, 'like'])->name('likePost');
Route::delete('/unlike/{postID}', [\App\Http\Controllers\front\LikeControlller::class, 'unlike'])->name('unlikePost');
...
//USERS
    Route::group(['prefix' => '/users' ], function (){
        ...
        Route::delete('/delete/{id}', [\App\Http\Controllers\back\UserController::class, 'destroy'])->name('deleteUser');
        Route::get('/edit/{id}', [\App\Http\Controllers\back\UserController::class, 'edit'])->name('editUser');
        Route::patch('/update/{id}', [\App\Http\Controllers\back\UserController::class, 'update'])->name('updateUser');
        Route::patch('/update-password/{id}', [\App\Http\Controllers\back\UserController::class, 'updatePassword'])->name('updateUserPassword');
...
//NEWS - POSTS
    Route::group(['prefix' => '/posts' ], function (){
        ...
        Route::delete('/delete/{id}', [\App\Http\Controllers\back\PostController::class, 'destroy'])->name('deletePost');
        ...
        Route::get('/edit/{id}', [\App\Http\Controllers\back\PostController::class, 'edit'])->name('editPost');
        Route::put('/update/{id}', [\App\Http\Controllers\back\PostController::class, 'update'])->name('updatePost');
        Route::patch('/approve/{id}', [\App\Http\Controllers\back\PostController::class, 'approve'])->name('approvePost');
...
//ROLES
    Route::group(['prefix' => '/roles' ], function (){
        ...
        Route::delete('/delete/{id}', [\App\Http\Controllers\back\RoleController::class, 'destroy'])->name('deleteRole');
        Route::get('/edit/{id}', [\App\Http\Controllers\back\RoleController::class, 'edit'])->name('editRole');
        Route::put('/update/{id}', [\App\Http\Controllers\back\RoleController::class, 'update'])->name('updateRole');
...
//TAGS
    Route::group(['prefix' => '/tags' ], function (){
        ...
        Route::delete('/delete/{id}', [\App\Http\Controllers\back\TagController::class, 'destroy'])->name('deleteTag');
        Route::get('/edit/{id}', [\App\Http\Controllers\back\TagController::class, 'edit'])->name('editTag');
        Route::put('/update/{id}', [\App\Http\Controllers\back\TagController::class, 'update'])->name('updateTag');
...
//CATEGORIES
    Route::group(['prefix' => '/categories' ], function (){
        ...
        Route::delete('/delete/{id}', [\App\Http\Controllers\back\CategoryController::class, 'destroy'])->name('deleteCategory');
        Route::get('/edit/{id}', [\App\Http\Controllers\back\CategoryController::class, 'edit'])->name('editCategory');
        Route::put('/update/{id}', [\App\Http\Controllers\back\CategoryController::class, 'update'])->name('updateCategory');
...
//FORBIDDEN WORDS
    Route::group(['prefix' => '/forbidden-words' ], function (){
        ...
        Route::delete('/delete/{id}', [\App\Http\Controllers\back\BadWordController::class, 'destroy'])->name('deleteForbiddenWord');
        Route::get('/edit/{id}', [\App\Http\Controllers\back\BadWordController::class, 'edit'])->name('editForbiddenWord');
        Route::put('/update/{id}', [\App\Http\Controllers\back\BadWordController::class, 'update'])->name('updateForbiddenWord');
...
//COMMENTS
    Route::group(['prefix' => '/comments' ], function (){
        ...
        Route::delete('/delete/{id}', [\App\Http\Controllers\back\CommentController::class, 'destroy'])->name('deleteComment');
...
//PERMISSIONS
    Route::group(['prefix' => '/permissions' ], function (){
        ...
        Route::delete('/delete/{id}', [\App\Http\Controllers\back\PermissionController::class, 'destroy'])->name('deletePermission');
        Route::get('/edit/{id}', [\App\Http\Controllers\back\PermissionController::class, 'edit'])->name('editPermission');
        Route::put('/update/{id}', [\App\Http\Controllers\back\PermissionController::class, 'update'])->name('updatePermission');
...
//PERMISSIONS ROLES
    Route::group(['prefix' => '/permissions-roles' ], function (){
        ...
        Route::get('/permissions/{id}', [\App\Http\Controllers\back\PermissionRoleController::class, 'show'])->name('showPermissions');
